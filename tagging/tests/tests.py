...
class TestParseTagInput(TestCase):
    def test_with_simple_space_delimited_tags(self):
        ...
        self.assertEquals(
            parse_tag_input("one, two, three"), [u"one", u"three", u"two"]
        )
...
class TestTagFieldInForms(TestCase):
    ...
    def test_recreation_of_tag_list_string_representations(self):
        ...
        self.assertEquals(
            edit_string_for_tags([plain, spaces, comma]), u'plain, spa ces, "com,ma"'
        )
    ...
    def test_tag_d_validation(self):
        ...
        try:
            ...
            self.assertEquals(
                str(ve), "[u'Each tag may be no more than 50 characters long.']"
            )
        except Exception, e:
            raise e
        else:
