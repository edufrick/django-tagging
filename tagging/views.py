...
def tagged_object_list(
    ...
    **kwargs
    ...
    if queryset_or_model is None:
        try:
            ...
            raise AttributeError(
                _("tagged_object_list must be called with a queryset or a model.")
            )
    ...
    if related_tags:
        kwargs["extra_context"]["related_tags"] = Tag.objects.related_for_model(
            tag_instance, queryset_or_model, counts=related_tag_counts
        )
